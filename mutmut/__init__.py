...
class MutationStrategy(ABC):
    @abstractmethod
    def mutate(self, node: Any, value: Optional[str] = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> Any:
        pass

#----------- mutations -----------

class NumberMutationStrategy(MutationStrategy):
    def mutate(self, node, value: str = None, **kwargs) -> str:
        suffix = ''
...
class FstringMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: Optional[str] = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> List[Any]:
...
class KeywordMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: str = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> Optional[str]:
...
class OperatorMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: str = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> Optional[Any]:
...
class NameMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: str = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> Optional[str]:
        simple_mutants = {
            'True': 'False',
            'False': 'True',
...
class ArgumentMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: Optional[str] = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> Optional[List[Any]]:
...
class AndOrTestMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: Optional[str] = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> List[Any]:
        children = children[:]
        children[1] = Keyword(
...
class LambdaMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: Optional[str] = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> List[Any]:
...
class ExpressionMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: Optional[str] = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> List[Any]:
...
class DecoratorMutationStrategy(MutationStrategy):
    def mutate(self, node: Any, value: Optional[str] = None, children: Optional[List[Any]] = None, context: Optional[Any] = None) -> List[Any]:
        assert children[-1].type == 'newline'
        return children[-1:]

# ----------- end of classes for the mutations -----------
...
# new for the strategies in the pattern
mutations_by_type = {
    'operator': OperatorMutationStrategy(),
    'keyword': KeywordMutationStrategy(),
    'number': NumberMutationStrategy(),
    'name': NameMutationStrategy(),
    'string': StringMutationStrategy(),
    'fstring': FstringMutationStrategy(),
    'argument': ArgumentMutationStrategy(),
    'or_test': AndOrTestMutationStrategy(),
    'and_test': AndOrTestMutationStrategy(),
    'lambdef': LambdaMutationStrategy(),
    'expr_stmt': ExpressionMutationStrategy(),
    'decorator': DecoratorMutationStrategy(),
    'annassign': ExpressionMutationStrategy(),
}
...
# TODO: review if some mutations are not working
def mutate_node(node, context: Context):
    ...
    try:
        ...
        strategy = mutations_by_type.get(node.type)

        if strategy:
            # obtaining the strategy for the mutation
            old = getattr(node, 'value', None) or getattr(node, 'children', None)
            if context.exclude_line():
                return

            # applying the mutation
            new = strategy.mutate(node=node, value=getattr(node, 'value', None), children=getattr(node, 'children', None), context=context)

            # handling the case of multiple mutations
            ...
            for new in reversed(new_list):
                ...
                if new is not None and new != old:
                    ...
                    if context.should_mutate(node):
                        ...
                        setattr(node, 'value' if hasattr(node, 'value') else 'children', new)
                    context.index += 1
                if context.performed_mutation_ids and context.mutation_id != ALL:
                    return
    finally:
